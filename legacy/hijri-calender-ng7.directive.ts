/**
 * HijriCalenderDirective — Angular 7+ compatible (TypeScript 3.x)
 *
 ...
 *   <input type="text" readonly hijri-calender name="d" [(ngModel)]="model.hijriDate" />
 *
 *   <!-- ngModel gets Gregorian value -->
 *   <input type="text" readonly hijri-calender [bindValue]="'gregorian'"
 *          name="d" [(ngModel)]="model.gregDate" />
 */
...
// ── Update this import path to match your project layout ──────────────────────
import {
  ...
  DAY_NAMES_SHORT_AR,
  pad2,
} from '../assets/hijri-calender/hijri-calendar.lib';

@Directive({
  // NOTE: No 'standalone: true' — declare this directive in your NgModule
  selector: '[hijri-calender]',
  providers: [{
...
export class HijriCalenderDirective implements ControlValueAccessor, AfterViewInit, OnDestroy {
  ...
  private renderCalendar(): void {
    ...
    this.popup.addEventListener('mousedown', function(e) { e.stopPropagation(); });
